...
public struct IPAddress: CustomStringConvertible, Comparable, Equatable {
...
public struct IPRange: IPRangeProtocol {
    /// First IP address
...
public protocol IPRangeProtocol: Equatable {
